...
public class ListaFilmesEmBreveAdapter extends RecyclerView.Adapter<ListaFilmesEmBreveAdapter.ListaFilmesEmBreveViewHolder> {

    private List<Filme> filmes;
    private static ItemFilmeClickListener itemFilmeClickListener;
    public ListaFilmesEmBreveAdapter(ItemFilmeClickListener itemFilmeClickListener) {
    ...
    @NonNull
    @Override
    public ListaFilmesEmBreveViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_filme, parent, false);
        return new ListaFilmesEmBreveViewHolder(view);
    }

    //ATRIBUI OS VALORES AOS COMPONENTES PARA CADA ITEM DA LISTA NA POSIÇÃO ESPECÍFICA
    @Override
    public void onBindViewHolder(@NonNull ListaFilmesEmBreveViewHolder holder, int position) {
    ...
    static class ListaFilmesEmBreveViewHolder extends RecyclerView.ViewHolder {

        private TextView textTituloFilme;
        private ImageView imagePosterFilme;
        private Filme filme;
        public ListaFilmesEmBreveViewHolder(View itemView) {
            super(itemView);
